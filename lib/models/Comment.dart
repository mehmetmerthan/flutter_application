...
class Comment extends amplify_core.Model {
  ...
  const Comment._internal({required this.id, content, required postID, createdAt, updatedAt}): _content = content, _postID = postID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Comment({String? id, String? content, required String postID}) {
  ...
  Comment copyWith({String? content, String? postID}) {
    return Comment._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'content': _content, 'postID': _postID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
